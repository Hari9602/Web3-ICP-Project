...
import { idlFactory } from './feedblok_backend.did.js';
export { idlFactory } from './feedblok_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FEEDBLOK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./feedblok_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the feedblok_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./feedblok_backend.did.js")._SERVICE>}
 */
export const feedblok_backend = createActor(canisterId);
