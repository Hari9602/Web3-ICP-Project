...
import { idlFactory } from './feedblok_frontend.did.js';
export { idlFactory } from './feedblok_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FEEDBLOK_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./feedblok_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the feedblok_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./feedblok_frontend.did.js")._SERVICE>}
 */
export const feedblok_frontend = createActor(canisterId);
